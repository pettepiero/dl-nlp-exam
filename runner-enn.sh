...
python experiment_sst-2-version5.py --suffix "$SLURM_JOB_ID" --save_params --save_params_path "outputs/job_$SLURM_JOB_ID/params_$SLURM_JOB_ID.npz" --learning_rate 1e-4
