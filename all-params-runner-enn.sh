...
python experiment_sst-2-version5.py --train_all --suffix "$SLURM_JOB_ID" --save_params --save_params_path "outputs/job_$SLURM_JOB_ID/all-params_$SLURM_JOB_ID.npz" --priority "$1"
